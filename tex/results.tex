...
\subsubsection{Injectivity test}
...
\begin{figure}[h!]
    ...
    \label{cht:gelexp5_1} % 4.3 supplimentary
\end{figure}
...
\begin{figure}[h!]
    ...
    \label{cht:phProduced} % 4.5 supplimentary
\end{figure}
...
\begin{figure}[h!]
    ...
    \label{cht:gelexp5_2} % 4.7 supplimentary
\end{figure}

\FloatBarrier
\section{Effect of pH on in situ gelling \label{sec:phInSitu}} \index{pH}
